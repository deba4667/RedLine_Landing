      ...
      <div className="container mx-auto px-4">
          ...
          <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/about-us" className="text-gray-400 hover:text-redline transition-colors">About Us</Link></li>
                <li><Link to="/careers" className="text-gray-400 hover:text-redline transition-colors">Careers</Link></li>
                <li><Link to="/privacy-policy" className="text-gray-400 hover:text-redline transition-colors">Privacy Policy</Link></li>
                <li><Link to="/terms-of-service" className="text-gray-400 hover:text-redline transition-colors">Terms of Service</Link></li>
                <li><Link to="/cookies-policy" className="text-gray-400 hover:text-redline transition-colors">Cookies Policy</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#services" className="text-gray-400 hover:text-redline transition-colors">Chat/Email Support</a></li>
                <li><a href="#services" className="text-gray-400 hover:text-redline transition-colors">Technical Support</a></li>
                <li><a href="#services" className="text-gray-400 hover:text-redline transition-colors">Virtual Assistance</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <Link to="/terms-of-service" className="text-gray-400 hover:text-redline text-sm transition-colors">Terms of Service</Link>
            <Link to="/privacy-policy" className="text-gray-400 hover:text-redline text-sm transition-colors">Privacy Policy</Link>
            <Link to="/cookies-policy" className="text-gray-400 hover:text-redline text-sm transition-colors">Cookie Policy</Link>
          </div>
        </div>
      </div>
    </footer>
