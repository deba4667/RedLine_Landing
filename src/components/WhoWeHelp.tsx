        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0 pr-0 md:pr-12">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Badge variant="outline" className="bg-white text-redline border-redline">Insurance Companies</Badge>
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-lg text-blueline-light mb-6">
              We work with Insurance Companies, Brokers, and Policy Administrators in the US and UK who want to
              enhance client experience while reducing operational burden.
            </p>
            <p className="text-lg text-blueline-light mb-8">
              Redline delivers reliable, human-first voice support tailored to the insurance industry, helping you focus on core business activities while ensuring excellent customer service.
            </p>
